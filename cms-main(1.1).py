...
def classprofile():#classprofile
    ...
    Button(cprofile,text='Remove Student').place(x=650,y=37)
    ...
    Button(cprofile,text='Class Performance',fg="red").place(x=750,y=37)
    Button(cprofile,text='Student Report',fg="red").place(x=860,y=37)
    ...
    Label(cprofile,text='**Student Report & Class performance features will be available on version 1.2').grid(row=10,column=2)
    Label(cprofile,text='**Attendance Records & Remove Student feature will be available on version 1.3 - Stay Connected for More Updates').grid(row=11,column=2)
...
def accwindow():#mainprofile
    ...
    Label(dash,text='Your DashBoard',font='Helvetica 12 bold').grid(row=1,column=2)
    Label(dash,text='Your Name: '+finaln).grid(row=2,column=1)
    Label(dash,text='Email: '+email).grid(row=3,column=1)
    Label(dash,text='No. of classes:'+co).grid(row=4,column=1)
    Button(dash,text='Create New Class',command=newclass).grid(row=5,column=1)
    Label(dash,text='Select Class>>>>').grid(row=6,column=1)
...
def sign():
    ...
    Button(sign,text='CreateAccount',command=account).grid(row=1,column=3)
    ...
    Button(sign,text='Proceed',command=proceed1).grid(row=4,column=3)
...
Label(home,text='---HOME PAGE---',font='Helvetica 12 bold').grid(row=1,column=3)
Label(home,text='version 1.1').grid(row=1,column=4)
Button(home,text='SignIn/Create Account',command=sign).grid(row=2,column=3)
Button(home,text='Subject Projection',command=subpro).grid(row=3,column=3)

Button(home,text='percentage calculator',command=calculator).grid(row=4,column=3)
Label(home,text='**when moving to other windows, do not close this main window!').grid(row=5,column=3)
Label(home,text='**sign in/create account to Start').grid(row=6,column=3)
Label(home,text='GitHub: https://github.com/andrew-geeks').grid(row=7,column=3)
Label(home,text='Twitter: https://twitter.com/andrewissac20').grid(row=8,column=3)
Label(home,text='Instagram: https://www.instagram.com/_andrewissac').grid(row=9,column=3)
Label(home,text='Read the tutorial file on how to get around. Enjoy!!😀').grid(row=10,column=3)
home.mainloop()
